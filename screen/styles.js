...
var sizePercent = 0.25;
var imageTopPort = height > width ? width - (width * sizePercent) : height - (height * sizePercent);
...
const styles = StyleSheet.create({
  ...
  textTitle: {
    ...
    fontWeight: 'bold',
    color: 'white',
    fontSize: width > 700 ? 30 : 14,
  },
  textDescription: {
    color: 'white',
    fontSize: width > 700 ? 25 : 12,
    marginHorizontal: (width - imageTopPort) / 6,
  },
  textImage: {
    marginTop: 5,
    color: 'white',
